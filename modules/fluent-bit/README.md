...
| <a name="input_extra_values"></a> [extra\_values](#input\_extra\_values) | Extra Helm values merged on top of the values generated by this module (e.g. `luaScripts` to mount custom Lua filter scripts) | `any` | `{}` | no |
